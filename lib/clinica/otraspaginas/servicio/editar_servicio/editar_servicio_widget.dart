...
class EditarServicioWidget extends StatefulWidget {
  ...
  final ServiciosRecord? serviceToEdit;
...
class _EditarServicioWidgetState extends State<EditarServicioWidget> {
  ...
  void initState() {
    ...
    _model.tfNombreServicioTextController ??=
        TextEditingController(text: widget.serviceToEdit?.nombreServicio);
    _model.tfNombreServicioFocusNode ??= FocusNode();

    _model.tfShortDescTextController ??=
        TextEditingController(text: widget.serviceToEdit?.descripcionServicio);
    _model.tfShortDescFocusNode ??= FocusNode();

    _model.tfLongDescTextController ??=
        TextEditingController(text: widget.serviceToEdit?.descripcionLarga);
    _model.tfLongDescFocusNode ??= FocusNode();

    _model.tfPriceTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      formatNumber(
        widget.serviceToEdit?.precio,
    ...
    _model.tfDurationTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.serviceToEdit?.duracion.toString(),
      '0',
    ));
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.tfNombreServicioTextController,
                                    focusNode: _model.tfNombreServicioFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                await widget.serviceToEdit!.reference
                                  ...
                                  imagenServicio: (_model.uploadedLocalFile1.bytes
                                                  ?.isNotEmpty ??
                                              false)
                                      ? _model.uploadedFileUrl2
                                      : widget.serviceToEdit?.imagenServicio,
                                  disponible:
                                      _model.rbDisponibleValue != null &&
                                          _model.rbDisponibleValue != '',
                                ));

                                context
                                    .pushNamed(ConfiguracionWidget.routeName);
