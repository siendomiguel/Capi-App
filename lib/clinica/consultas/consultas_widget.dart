...
class ConsultasWidget extends StatefulWidget {
  ...
  static String routeName = 'Consultas';
  static String routePath = '/consultas';

  @override
  State<ConsultasWidget> createState() => _ConsultasWidgetState();
}
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 18.0),
                                  child: Text(
                                    'Debajo verá el historico de consultas',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(),
                                    child: wrapWithModel(
                                      model: _model.tablaConsultasModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: TablaConsultasWidget(),
                                    ),
                                  ),
