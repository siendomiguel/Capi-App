...
class ConversacionesWidget extends StatefulWidget {
  const ConversacionesWidget({super.key});

  static String routeName = 'conversaciones';
  static String routePath = '/conversaciones';

  @override
  State<ConversacionesWidget> createState() => _ConversacionesWidgetState();
}
