...
import 'mi_plan_model.dart';
export 'mi_plan_model.dart';

class MiPlanWidget extends StatefulWidget {
  const MiPlanWidget({super.key});

  static String routeName = 'miPlan';
  static String routePath = '/mi-plan';

  @override
  State<MiPlanWidget> createState() => _MiPlanWidgetState();
}

class _MiPlanWidgetState extends State<MiPlanWidget> {
  late MiPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MiPlanModel());
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<ClinicaRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final miPlanClinicaRecord = snapshot.data!;
                                                    ...
                                                    child: Text(
                                                      valueOrDefault<String>(
                                                        (miPlanClinicaRecord
                                                            ...
                                                            ? valueOrDefault<
                                                                String>(
                                                                'Acceso a ${miPlanClinicaRecord.nombrePlan}',
