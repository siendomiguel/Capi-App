...
import 'crear_paciente_model.dart';
export 'crear_paciente_model.dart';

class CrearPacienteWidget extends StatefulWidget {
  const CrearPacienteWidget({super.key});

  static String routeName = 'crearPaciente';
  static String routePath = '/crearPaciente';

  @override
  State<CrearPacienteWidget> createState() => _CrearPacienteWidgetState();
}

class _CrearPacienteWidgetState extends State<CrearPacienteWidget> {
  late CrearPacienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearPacienteModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textFieldTextController3?.text = '0';
          _model.textFieldTextController4?.text = '0';
        }));
  }
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              'Fecha de Nacimiento: ${valueOrDefault<String>(
                                                dateTimeFormat(
                                                  "d/M/y",
                                                  _model.datePicked,
                                                ...
                                                builder: (alertDialogContext) {
                                                  return WebViewAware(
                                                    child: AlertDialog(
                                                      title: Text('Salir'),
                                                      content: Text(
                                                          'Confirmas que deseas salir sin crear un paciente?'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                      ...
                                      try {
                                        ...
                                        if (containerUsersRecordList.length <
                                          ...
                                          if ((_model.textFieldEmailTextController
                                            ...
                                            await actions.customPrint(
                                              'Antes de crear usuario en firebase',
                                            );
                                            _model.crearPaciente =
                                            ...
                                            await Future.delayed(const Duration(
                                                milliseconds: 1000));
                                            await actions.customPrint(
                                              'Despues de crear usuario en firebase',
                                            );
                                            ...
                                            _model.readPaciente =
                                              ...
                                              queryBuilder: (usersRecord) =>
                                                  usersRecord.where(
                                                'uid',
                                                isEqualTo: _model.crearPaciente,
                                              ),
                                              singleRecord: true,
                                            ).then((s) => s.firstOrNull);
                                            await actions.customPrint(
                                              'Despues de consultar usuario',
                                            );

                                            firestoreBatch.update(
                                                _model.readPaciente!.reference,
                                                {
                                                  ...createUsersRecordData(
                                                    displayName:
                                                        '${_model.nombreTextController.text} ${_model.apellidoTextController.text} ${_model.textFieldTextController1.text}',
                                                    phoneNumber: _model
                                                        .textFieldCelularTextController
                                                        .text,
                                                    role: 'Paciente',
                                                    ...
                                                    genero:
                                                        _model.rbGeneroValue,
                                                    religion: _model
                                                        .textFieldTextController9
                                                        .text,
                                                    direccion:
                                                    ...
                                                    tipoSangre: _model
                                                        .ddTipoSangreValue,
                                                    seguroMedico:
                                                        createSeguroMedicoStruct(
                                                      tieneSeguro:
                                                          _model.rbSeguroValue ==
                                                                  'Si'
                                                              ? true
                                                              : false,
                                                      tipoSeguro: _model
                                            ...
                                            await actions.customPrint(
                                              'Despues de guardar datos en firebase',
                                            );
                                            ...
                                            await actions.customPrint(
                                              'Despues de actualizar pacientes de la clinica',
                                            );
                                            await Future.delayed(const Duration(
                                                milliseconds: 1000));
                                            _model.readPacienteDocument =
                                                await UsersRecord
                                                    .getDocumentOnce(_model
                                                        .readPaciente!
                                                        .reference);
                                            await actions.customPrint(
                                              'Despues de consultar usuario 2',
                                            );
                                            FFAppState().alergias = [];
                                            FFAppState().datosFamiliares = [];
                                            FFAppState().myCurrentLocation =
                                              ...
                                              return WebViewAware(
                                                child: AlertDialog(
                                                  title:
                                                      Text('Crear Pacientes'),
                                                  content: Text(
                                                      'Alcansaste el limite de pacientes de tu plan...!'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
