...
import 'olvido_contrasena_model.dart';
export 'olvido_contrasena_model.dart';

class OlvidoContrasenaWidget extends StatefulWidget {
  const OlvidoContrasenaWidget({super.key});

  static String routeName = 'olvidoContrasena';
  static String routePath = '/olvidoContrasena';

  @override
  State<OlvidoContrasenaWidget> createState() => _OlvidoContrasenaWidgetState();
}
