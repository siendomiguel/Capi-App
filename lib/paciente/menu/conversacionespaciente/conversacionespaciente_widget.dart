...
import 'conversacionespaciente_model.dart';
export 'conversacionespaciente_model.dart';

class ConversacionespacienteWidget extends StatefulWidget {
  const ConversacionespacienteWidget({super.key});

  static String routeName = 'conversacionespaciente';
  static String routePath = '/conversacionespaciente';

  @override
  State<ConversacionespacienteWidget> createState() =>
      _ConversacionespacienteWidgetState();
}

class _ConversacionespacienteWidgetState
    extends State<ConversacionespacienteWidget> with TickerProviderStateMixin {
  late ConversacionespacienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConversacionespacienteModel());
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'A continuación están tus conversaciones.',
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              stream: UsersRecord.getDocument(listViewChatsRecord.userB!),
                                                                              builder: (context, snapshot) {
                                                                                // Customize what your widget looks like when it's loading.
                                                                                if (!snapshot.hasData) {
                                                                                  return Center(
