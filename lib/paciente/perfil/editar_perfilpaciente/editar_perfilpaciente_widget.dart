...
import 'editar_perfilpaciente_model.dart';
export 'editar_perfilpaciente_model.dart';

class EditarPerfilpacienteWidget extends StatefulWidget {
  const EditarPerfilpacienteWidget({super.key});

  static String routeName = 'editarPerfilpaciente';
  static String routePath = '/editePerfilpaciente';

  @override
  State<EditarPerfilpacienteWidget> createState() =>
      _EditarPerfilpacienteWidgetState();
}

class _EditarPerfilpacienteWidgetState
    extends State<EditarPerfilpacienteWidget> {
  late EditarPerfilpacienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPerfilpacienteModel());
    ...
    _model.textFieldTextController5 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.longDescription, ''));
    ...
    _model.textFieldTelefonoTextController2 ??= TextEditingController(
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await currentUserReference!
                              ...
                              phoneNumber:
                                  _model.textFieldTelefonoTextController1.text,
                              shortDescription:
                                  _model.textFieldTextController4.text,
                              nombre: _model.textFieldTextController1.text,
                              apellidoPaterno:
                                  _model.textFieldTextController2.text,
                              apellidoMaterno:
                                  _model.textFieldTextController3.text,
                              edad: functions
                                  .calcularEdad(_model.datePicked != null
                                      ? _model.datePicked!
                                      : currentUserDocument!.fechaNacimiento!)
                                  .toString(),
                              fechaNacimiento: _model.datePicked != null
                                  ? _model.datePicked
                                  : currentUserDocument?.fechaNacimiento,
                              otroTelefono:
                                  _model.textFieldTelefonoTextController2.text,
                            ...
                            context.pushNamed(PerfilPacienteWidget.routeName);
                          },
                          text: 'Guardar',
                          options: FFButtonOptions(
                            width: 120.0,
