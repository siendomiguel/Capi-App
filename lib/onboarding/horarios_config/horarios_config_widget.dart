...
import 'horarios_config_model.dart';
export 'horarios_config_model.dart';

class HorariosConfigWidget extends StatefulWidget {
  const HorariosConfigWidget({
    super.key,
    this.choiseSelect,
  });

  final String? choiseSelect;

  @override
  State<HorariosConfigWidget> createState() => _HorariosConfigWidgetState();
}

class _HorariosConfigWidgetState extends State<HorariosConfigWidget> {
  late HorariosConfigModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HorariosConfigModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((currentUserDocument?.availability.toList() ?? []).isNotEmpty) {
        ...
        FFAppState().availability = functions
            .initialAvailability(9, 17)!
            .toList()
            .cast<AvailabilityStruct>();
        safeSetState(() {});
      }
        ...
        child: Column(
          ...
          children: [
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Importante: Estos son los horarios asociados a tu cuenta independientemente de la clínica.',
            ...
            Align(
              ...
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(16.0, 30.0, 0.0, 30.0),
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (widget.choiseSelect != null &&
                        widget.choiseSelect != '') {
                      await action_blocks.navegacionMenuOnboarding(
                        context,
                        choiseSelect: widget.choiseSelect,
                      );
                    }
                  },
