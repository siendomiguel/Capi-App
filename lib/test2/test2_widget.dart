import '/components/card_test_widget.dart';
                          ...
                          children: [
                            ...
                            Builder(
                              builder: (context) => FFButtonWidget(
                                onPressed: () async {
                                  await actions.openWindowBrowser();
                                  await showDialog(
                                    context: context,
                                          ...
                                          child: Padding(
                                            ...
                                            child: ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(10.0),
                                              child: Image.network(
                                                'https://source.unsplash.com/random/1280x720?profile&1',
                                                width: 60.0,
                                                height: 60.0,
                                                fit: BoxFit.cover,
                                              ),
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          _model.list = await actions.searchCIE10(
