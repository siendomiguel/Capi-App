...
export 'family_info_model.dart';

class FamilyInfoWidget extends StatefulWidget {
  const FamilyInfoWidget({super.key});
...
class _FamilyInfoWidgetState extends State<FamilyInfoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FamilyInfoModel());
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              FlutterFlowDropDown<String>(
                                                controller: _model
                                                        .dropDownParentezcoValueController ??=
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  controller: _model
                                                          .dropDownTipoSangreValueController ??=
                                                      FormFieldController<
                                                          String>(null),
                                                  options: [
                                                    'A+',
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.dropDownParentezcoValue ==
                                            null) {
                                          return;
                                        }
                                        if (_model.dropDownTipoSangreValue ==
                                            null) {
                                          return;
                                        }
                                        ...
                                        FFAppState().addToDatosFamiliares(
                                            InfoFamiliarStruct(
                                          parentezco:
                                              _model.dropDownParentezcoValue,
                                          nombre:
                                          ...
                                          tipoDeSangre:
                                              _model.dropDownTipoSangreValue,
                                        ...
                                        safeSetState(() {
                                          ...
                                          _model.dniTextController?.clear();
                                        });
                                        safeSetState(() {
                                          _model
                                              .dropDownParentezcoValueController
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Información familiar añadida con exito!',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .secondaryBackground,
