...
import 'nueva_cita_original_model.dart';
export 'nueva_cita_original_model.dart';

class NuevaCitaOriginalWidget extends StatefulWidget {
  const NuevaCitaOriginalWidget({
    super.key,
    this.paciente,
  });
  ...
  @override
  State<NuevaCitaOriginalWidget> createState() =>
      _NuevaCitaOriginalWidgetState();
}

class _NuevaCitaOriginalWidgetState extends State<NuevaCitaOriginalWidget>
    with TickerProviderStateMixin {
  late NuevaCitaOriginalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NuevaCitaOriginalModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault<bool>(currentUserDocument?.horarios, false) == false) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                title: Text('Configuración incompleta'),
                content: Text('Aún no configuraste los horarios de atención'),
                actions: [
                  TextButton(
      ...
      } else if (valueOrDefault<bool>(currentUserDocument?.servicios, false) ==
          false) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                title: Text('Configuración incompleta'),
                content: Text('Aún no configuraste los servicios a prestar'),
                actions: [
                  TextButton(
                    onPressed: () => Navigator.pop(alertDialogContext),
                    child: Text('Ok'),
      ...
      } else if (valueOrDefault<bool>(currentUserDocument?.equipo, false) ==
          false) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                title: Text('Configuración incompleta'),
                content: Text(
                    'Aún no configuraste los miembros del equipo asociado a los servicios prestados'),
                actions: [
                  TextButton(
                    onPressed: () => Navigator.pop(alertDialogContext),
                    child: Text('Ok'),
      ...
      } else if (valueOrDefault<bool>(currentUserDocument?.zoom, false) ==
          false) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                title: Text('Configuración incompleta'),
                content: Text(
                    'Aún no configuraste tu link de Zoom , para poder realizar citas virtuales'),
                actions: [
                  TextButton(
                    onPressed: () => Navigator.pop(alertDialogContext),
                    child: Text('Ok'),
      ...
      } else if (valueOrDefault<bool>(currentUserDocument?.stripe, false) ==
          false) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                title: Text('Configuración incompleta'),
                content: Text(
                    'Aún no configuraste  tu credencial de stripe , para obtener pagos por la plataforma'),
                actions: [
                  TextButton(
                    onPressed: () => Navigator.pop(alertDialogContext),
                    child: Text('Ok'),
                                                      ...
                                                      queryBuilder:
                                                          (citasRecord) =>
                                                              citasRecord
                                                                  ...
                                                                  .where(
                                                                    'doctor',
                                                                    isEqualTo: _model.ddDoctorValue !=
                                                                                null &&
                                                                            _model.ddDoctorValue !=
                                                                                ''
                                                                        ? _model
                                                            ...
                                                            Stack(
                                                              ...
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  child:
                                                                      Visibility(
                                                                    visible: !(functions.getAvailabileSlots(containerCitasRecordList.map((e) => e.fechaCIta).withoutNulls.toList(), _model.datePicked != null ? _model.datePicked! : FFAppState().SelectSlots!, _model.docID?.availability.toList(), _model.serviceID!.duracion) !=
                                                                            null &&
                                                                        (functions.getAvailabileSlots(
                                                                                containerCitasRecordList.map((e) => e.fechaCIta).withoutNulls.toList(),
                                                                                _model.datePicked != null ? _model.datePicked! : FFAppState().SelectSlots!,
                                                                      ...
                                                                      return WebViewAware(
                                                                        child:
                                                                          ...
                                                                          title:
                                                                              Text('Advertencia'),
                                                                          content:
                                                                              Text('No hay espacios libre para hoy'),
                                                                          actions: [
                                                                            TextButton(
                                                  ...
                                                  await notificacionesRecordReference
                                                    ...
                                                    mensaje:
                                                      ...
                                                      'Saludos ${valueOrDefault<String>(
                                                        _model.proID?.nombre,
                                                        '[noName]',
                                                      )} tienes una cita el ${dateTimeFormat(
                                                        "d/M/y",
                                                        _model.datePicked,
                                                        locale:
                                                            FFLocalizations.of(
