...
import 'tabla_archivos_model.dart';
export 'tabla_archivos_model.dart';

class TablaArchivosWidget extends StatefulWidget {
  const TablaArchivosWidget({
    super.key,
    required this.user,
  });
  ...
  @override
  State<TablaArchivosWidget> createState() => _TablaArchivosWidgetState();
}

class _TablaArchivosWidgetState extends State<TablaArchivosWidget> {
  late TablaArchivosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TablaArchivosModel());
