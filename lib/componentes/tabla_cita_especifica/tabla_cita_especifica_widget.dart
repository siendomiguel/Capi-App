...
import 'tabla_cita_especifica_model.dart';
export 'tabla_cita_especifica_model.dart';

class TablaCitaEspecificaWidget extends StatefulWidget {
  const TablaCitaEspecificaWidget({
    super.key,
    this.paciente,
  });
  ...
  @override
  State<TablaCitaEspecificaWidget> createState() =>
      _TablaCitaEspecificaWidgetState();
}

class _TablaCitaEspecificaWidgetState extends State<TablaCitaEspecificaWidget> {
  late TablaCitaEspecificaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TablaCitaEspecificaModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: AuthUserStreamWidget(
        builder: (context) => StreamBuilder<List<CitasRecord>>(
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                                            ...
                                                            return WebViewAware(
                                                              child:
                                                                ...
                                                                title: Text(
                                                                    'CIta por Confirmar'),
                                                                content: Text(
                                                                    'Esta cita aún no ha sido confirmada por el Doctor..!'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                                              ...
                                                              children: [
                                                                StreamBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final containerConsultaRecord = containerConsultaRecordList
                                                                            .isNotEmpty
                                                                        ? containerConsultaRecordList
                                                                            .first
                                                                        : null;
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child: StreamBuilder<
                                                                        ...
                                                                        stream:
                                                                            queryDiagnosticoTratamientoRecord(
                                                                          parent:
                                                                              containerConsultaRecord?.reference,
                                                                          singleRecord:
                                                                              true,
                                                                        ),
                                                                        builder:
                                                                          ...
                                                                          List<DiagnosticoTratamientoRecord>
                                                                              textDiagnosticoTratamientoRecordList =
                                                                              snapshot.data!;
                                                                          // Return an empty Container when the item does not exist.
                                                                          if (snapshot
                                                                              .data!
                                                                          ...
                                                                          final textDiagnosticoTratamientoRecord = textDiagnosticoTratamientoRecordList.isNotEmpty
                                                                              ? textDiagnosticoTratamientoRecordList.first
                                                                              : null;

                                                                          return Text(
                                                                            valueOrDefault<String>(
                                                                              textDiagnosticoTratamientoRecord?.diagnostico,
                                                                              'Sin diagnostico',
                                                                            ).maybeHandleOverflow(
                                                                              maxChars: 20,
                                                                              replacement: '…',
                                ...
                                if ((_model.searchCitas != null &&
                                        (_model.searchCitas)!.isNotEmpty) &&
                                    (_model.searchActive == true))
                                  Builder(
                                    builder: (context) {
                                      final searchPacienteEspecifico = _model
