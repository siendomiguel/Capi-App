...
class SideNavWidget extends StatefulWidget {
  const SideNavWidget({
    super.key,
    required this.estadisticasDoc,
    required this.citasDoc,
    required this.pacientesDoc,
    required this.calendarioDoc,
    required this.chatDoc,
    required this.consultasDoc,
    required this.notificacionesDoc,
    required this.configuracionDoc,
    required this.planDoc,
    this.calendarioPaceinte,
    this.citasPaciente,
    this.chatPaciente,
    this.datosPaciente,
  });

  final bool? estadisticasDoc;
  final bool? citasDoc;
  final bool? pacientesDoc;
  final bool? calendarioDoc;
  final bool? chatDoc;
  final bool? consultasDoc;
  final bool? notificacionesDoc;
  final bool? configuracionDoc;
  final bool? planDoc;
  final bool? calendarioPaceinte;
  final bool? citasPaciente;
  final bool? chatPaciente;
  final bool? datosPaciente;
                                        ...
                                        () {
                                          if (_model.mouseRegionHovered1) {
                                            return FlutterFlowTheme.of(context)
                                                .secondaryBackground;
                                          } else if (widget.estadisticasDoc!) {
                                            return FlutterFlowTheme.of(context)
                                                .accent1;
                                          } else {
                                            return FlutterFlowTheme.of(context)
                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder<List<ChatsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<ChatsRecord>
                                      mnuChatsMedicosChatsRecordList =
                                      snapshot.data!;
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            if (mnuChatsMedicosChatsRecordList
                                                    .where((e) => !e
                                                        .lastMessageSeenBy
                                                        .contains(
                                          ...
                                          () {
                                            if (_model.mouseRegionHovered7) {
                                              return FlutterFlowTheme.of(
                                                      context)
                                                  .secondaryBackground;
                                            } else if (contentView1NotificacionesRecordList
                                                    .length >
                                                0) {
                                              return FlutterFlowTheme.of(
                                                      context)
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            if (contentView1NotificacionesRecordList
                                                    .length >
                                                0)
                                              Container(
                                                height: 32.0,
                                    ...
                                    color: valueOrDefault<Color>(
                                      () {
                                        if (_model.mouseRegionHovered8) {
                                          return FlutterFlowTheme.of(context)
                                              .secondaryBackground;
                                        } else if (widget.configuracionDoc!) {
                                          return FlutterFlowTheme.of(context)
                                              .accent1;
                                        } else {
                                          return FlutterFlowTheme.of(context)
                            ...
                            MouseRegion(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 16.0, 0.0),
                                child:
                                    StreamBuilder<List<NotificacionesRecord>>(
                                  stream: queryNotificacionesRecord(
                                    queryBuilder: (notificacionesRecord) =>
                                        notificacionesRecord.where(
                                      'especificUser',
