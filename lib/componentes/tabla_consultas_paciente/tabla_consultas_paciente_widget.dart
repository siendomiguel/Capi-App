...
import 'tabla_consultas_paciente_model.dart';
export 'tabla_consultas_paciente_model.dart';

class TablaConsultasPacienteWidget extends StatefulWidget {
  const TablaConsultasPacienteWidget({super.key});

  @override
  State<TablaConsultasPacienteWidget> createState() =>
      _TablaConsultasPacienteWidgetState();
}

class _TablaConsultasPacienteWidgetState
    extends State<TablaConsultasPacienteWidget> {
  late TablaConsultasPacienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TablaConsultasPacienteModel());
      ...
      child: AuthUserStreamWidget(
        builder: (context) => StreamBuilder<List<ConsultaRecord>>(
          stream: queryConsultaRecord(
            queryBuilder: (consultaRecord) => consultaRecord.where(
              'clinica',
                                              ...
                                              .map(
                                                (record) =>
                                                    TextSearchItem.fromTerms(
                                                        record, [
                                                  record.padecimientoActual,
                                                  record.objetivoConsulta
                                                ]),
                                              )
                                              .toList(),
                                        )
